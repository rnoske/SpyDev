...
#
# Created: Mon Oct 08 13:15:06 2012
...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 271, 161))
        ...
        QtCore.QObject.connect(self.actionLoad, QtCore.SIGNAL(_fromUtf8("activated()")), Settings.loadSettings)
        QtCore.QObject.connect(self.actionSave, QtCore.SIGNAL(_fromUtf8("activated()")), Settings.saveSettings)
